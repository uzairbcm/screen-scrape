...
class ScreenTimeRow:
    ...
    def headers(cls):
        return (
            ["Full path", "File name", "ID", "Date from file name", "App title"]
            + list(range(24))
            + ["Total"]
        )
...
class ScreenshotApp(QWidget):
    ...
    def init_ui(self):
        ...
        self.layout.addWidget(btn_battery)
        self.layout.addWidget(btn_screen_time)
        self.instruction_label = QLabel("Click Next/Save if the graphs match, otherwise click the upper left corner of the graph in the left image.")
        ...
        self.layout.addLayout(main_image_layout)
        ...
        cropped_image_layout.addWidget(self.instruction_label)
        ...
        self.resize(int(screen_geo.width() * 0.7), int(screen_geo.height() * 0.7))
    ...
    def capture_click(self, event):
        ...
        if self.click_count == 1:
            self.instruction_label.setText("Now click the bottom right corner of the graph in the left image.")
            ...
            self.coordinates = []
            self.click_count = 0
            self.instruction_label.setText("Click Next/Save if the graphs match, otherwise click the upper left corner of the graph in the left image.")
            self.instruction_label.setStyleSheet("background-color:rgb(255,255,150)")
    ...
    def update(self, title, row, processed_image_path, graph_image_path):
        ...
        if processed_image_path:
            ...
            self.instruction_label.setText("An error occurred, click the upper left corner of the graph in the left image to reselect")
